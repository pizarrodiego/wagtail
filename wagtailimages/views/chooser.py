...
def chooser(request):
    ...
    if 'q' in request.GET or 'p' in request.GET:
        ...
        if searchform.is_valid():
            ...
            # fork @dpizarro
            images = Image.search(q, results_per_page=settings.WAGTAILSEARCH_RESULTS_PER_PAGE, page=p)
            ...
            # fork @dpizarro
            paginator = Paginator(images, settings.WAGTAILSEARCH_RESULTS_PER_PAGE)
